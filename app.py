...
def user_login_view():
  ...
  return response
# Task 3.3 Here
@app.route('/identify') # GET is automatically assumed given there is none indicated 
@jwt_required()
def identify_view():
...
def create_user_todo():
  ...
  if user:
    ...
    return jsonify(message="An error occurd. Try again"), 400
  return jsonify(message="Invaliv user"), 403
